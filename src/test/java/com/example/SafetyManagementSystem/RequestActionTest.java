...
class RequestActionTest {
	...
	void testFindAllAction() {
		...
		Assert.assertEquals(actionlist.get(0).getPassword(), "080008");
		Assert.assertEquals(actionlist.get(1).getPassword(), "23456");
		Assert.assertEquals(actionlist.get(2).getPassword(), "34567");
		Assert.assertEquals(actionlist.get(3).getPassword(), "45678");
	}
